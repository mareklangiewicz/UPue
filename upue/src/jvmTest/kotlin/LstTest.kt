...
//    private val log = MySystemLogger() // FIXME_later: new minimalistic multiplatform logger?
    private val log = object { fun i(message: Any?) = println(message) }
